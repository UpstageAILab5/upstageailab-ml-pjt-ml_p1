...
with DAG(
    ...
    prepare_data_task = PythonOperator(
        ...
        python_callable=prepare_data,  # 실행할 Python 함수
        op_kwargs={  # 함수에 전달할 인자들
            'input_path': '/opt/airflow/data/tinybert_model.csv',
            'train_output_path': '/opt/airflow/data/tinybert_train.csv',
            'test_output_path': '/opt/airflow/data/tinybert_test.csv',
        },
    )
    ...
    train_model_task = PythonOperator(
        ...
        op_kwargs={
            'input_train_path': '/opt/airflow/data/tinybert_train.csv',
            'input_test_path': '/opt/airflow/data/tinybert_test.csv',
            'model_output_dir': '/opt/airflow/models/tinybert-sentiment-analysis',
            'train_output_dir': '/opt/airflow/train_dir',
        },
    )
    ...
    prepare_data_task >> train_model_task >> evaluate_model_task >> select_best_model_task